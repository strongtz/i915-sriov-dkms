# Linux i915 driver (dkms module) with SR-IOV support for linux 6.12
...
1. Execute the command `dkms install -m i915-sriov-dkms -v 2024.12.22 --force` or `dkms install -m i915-sriov-dkms -v $(cat VERSION) --force` for a version-independent command.
