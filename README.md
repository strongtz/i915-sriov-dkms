...
1. Download deb package from the [releases page](https://github.com/strongtz/i915-sriov-dkms/releases)
   ...
   ```
1. Install the deb package with dpkg: `dpkg -i /tmp/i915-sriov-dkms_2025.05.18_amd64.deb`
...
1. Install the module with DKMS: `dkms install i915-sriov-dkms/2025.05.18`.
