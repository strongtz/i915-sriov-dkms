# Linux i915 driver (dkms module) with SR-IOV support for linux 6.8-6.14
...
1. Download deb package from the [releases page](https://github.com/strongtz/i915-sriov-dkms/releases)
   ```sh
   wget -O /tmp/i915-sriov-dkms_2025.03.26_amd64.deb "https://github.com/strongtz/i915-sriov-dkms/releases/download/2025.03.26/i915-sriov-dkms_2025.03.26_amd64.deb"
   ```
1. Install the deb package with dpkg: `dpkg -i /tmp/i915-sriov-dkms_2025.03.26_amd64.deb`
...
2. Download and install the `.deb`
   ```
   wget -O /tmp/i915-sriov-dkms_2025.03.26_amd64.deb "https://github.com/strongtz/i915-sriov-dkms/releases/download/2025.03.26/i915-sriov-dkms_2025.03.26_amd64.deb"
   dpkg -i /tmp/i915-sriov-dkms_2025.03.26_amd64.deb
   ```
...
1. Install the module with DKMS: `dkms install i915-sriov-dkms/2025.03.26`.
...
### manual
Remove the dkms module with `dkms remove i915-sriov-dkms/2025.03.26`
