...
3. Download deb package from the [releases page](https://github.com/strongtz/i915-sriov-dkms/releases)
   ...
   ```
4. Install the deb package with dpkg: `dpkg -i /tmp/i915-sriov-dkms_2026.02.04_amd64.deb`
...
2. Download and install the `.deb`
   ```
   wget -O /tmp/i915-sriov-dkms_2026.02.04_amd64.deb "https://github.com/strongtz/i915-sriov-dkms/releases/download/2026.02.04/i915-sriov-dkms_2026.02.04_amd64.deb"
   dpkg -i /tmp/i915-sriov-dkms_2026.02.04_amd64.deb
   ```
...
1. Install the module with DKMS: `dkms install i915-sriov-dkms/2026.02.04`.
