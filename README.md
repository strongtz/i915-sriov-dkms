...
1. Download deb package from the [releases page](https://github.com/strongtz/i915-sriov-dkms/releases)
   ...
   ```
1. Install the deb package with dpkg: `dpkg -i /tmp/i915-sriov-dkms_2025.11.10_amd64.deb`
...
1. Install the module with DKMS: `dkms install i915-sriov-dkms/2025.11.10`.
...
### manual
Remove the dkms module with `dkms remove i915-sriov-dkms/2025.11.10`
