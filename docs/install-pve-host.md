...
3. Download deb package from the [releases page](https://github.com/strongtz/i915-sriov-dkms/releases)
   ```sh
   wget -O /tmp/i915-sriov-dkms_2026.03.05.1_amd64.deb "https://github.com/strongtz/i915-sriov-dkms/releases/download/2026.03.05.1/i915-sriov-dkms_2026.03.05.1_amd64.deb"
   ```
4. Install the deb package with dpkg: `dpkg -i /tmp/i915-sriov-dkms_2026.03.05.1_amd64.deb`
...
`dkms remove i915-sriov-dkms/2026.03.05.1`
